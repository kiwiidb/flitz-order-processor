module github.com/kiwiidb/flitz-storage-api
...
require (
	...
	github.com/kiwiidb/bliksem-library/utils v0.0.0-20190926180021-e32b2e824ca6
	github.com/kiwiidb/bliksem-library/vouchertemplating v0.0.0-20190909225434-25d390db5732
